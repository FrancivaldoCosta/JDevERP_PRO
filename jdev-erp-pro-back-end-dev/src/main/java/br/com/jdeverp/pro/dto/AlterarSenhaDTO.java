...
public class AlterarSenhaDTO {
	...
	@NotBlank(message = "Senha atual dese ser informada")
	@Size(min = 5, max = 50, message = "Senha atual deve ter entre 5 e 50 caracterees")
	...
	@NotBlank(message = "Confirmação da nova senha dever ser informada")
