...
public class JwtFilter extends OncePerRequestFilter {
	...
	/*FilterChain = Classe do filtro do Spring*/
	@Override
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			/*Se não tem token o acesso pode ser publico e será validado pelo Spring Security*/
			...
			/*Token pode ser inválido mas o user pode acessar a parte de login*/
			...
			if (login != null && SecurityContextHolder.getContext().getAuthentication() == null) {
				...
				/*Cria o objeto pra cerregar o user*/
