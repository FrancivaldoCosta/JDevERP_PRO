...
/*O QUE É O SERVICE*/
/* Dentro do service vc pode criar infinitos métodos, gerar grafico, api de pagamento, gerar relatórios e etc */
...
public class CategoriaService {
	...
	public boolean existeById(Long id, Long empresaId) {
		return categoriaRepository.existeById(id, empresaId);
	}
...
//	================ Dentro dos métodos do service ================ 
	
//	Verifica se está em uso
//	Realizar uma consulta com integração para saber se pode deletar
//	Fazer copia e backup
//	Fazer inumeras validações de regras de negocio
//	Fazer validações
//	Lançar exceções
